    ...
    <div class="row">
        <div class=" col-xs-12 col-sm-8 col-md-8 col-lg-8">
           <h3 class="widget-title mt-1" style="">
                <span class="title_span">{!! $page_name ?? '' !!}</span>
            </h3>
            <div class=" p-2">
              <div class="card p-2">
               ...
               <form action="{{url('new-member-save')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                   <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group ">
                                <label class="font-weight-bold">Admission Session:</label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group ">
                                <label class="font-weight-bold">Entery Degree:</label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group ">
                                <label class="font-weight-bold">Exit Degree:</label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group ">
                                <label class="font-weight-bold">Entry Degree Comletion Year:</label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group ">
                                <label class="font-weight-bold">Exit Degree Comletion Year:</label>
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6 col-xs-6">
                      <div class="form-group">
                          ...
                          <select name="session_bs_bsc _session_select" class="form-control" >
                            <option value="">--Select--</option>
                            @forelse($examsessions as $key=>$val)
                              <option value="{{ $val->id }}"
                  ...
                  <div class="col-sm-6 col-md-6 col-xs-6">
                      <div class="form-group">
                          ...
                          <select class="form-control bsc_year_passing _year_select" name="bs_bsc_certificate_year" id="bs_bsc_certificate_year" >
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6 col-xs-6">
                      <div class="form-group">
                          ...
                          <select name="session_ms_msc" class="form-control _session_select" id="session_ms_msc" >
                            <option value="">--Select--</option>
                            @forelse($examsessions as $key=>$val)
                              <option value="{{ $val->id }}"
                  ...
                  <div class="col-sm-6 col-md-6 col-xs-6">
                      <div class="form-group">
                          ...
                          <select class="form-control bsc_year_passing _year_select" name="ms_msc_certificate_year" id="ms_msc_certificate_year" >
                                @forelse($bsc_year_passing as $key=>$val)
                                 <option value="{{ $val->id ?? '' }}"
                                  @if(old('bsc_year_passing')==$val->id) selected @endif 
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6 col-xs-6">
                      <div class="form-group">
                          ...
                          <select name="session_mphil" class="form-control _session_select" id="session_mphil" >
                            <option value="">--Select--</option>
                            @forelse($examsessions as $key=>$val)
                              <option value="{{ $val->id }}"
                  ...
                  <div class="col-sm-6 col-md-6 col-xs-6">
                      <div class="form-group">
                          ...
                          <select class="form-control bsc_year_passing _year_select" name="mphil_certificate_year" id="mphil_certificate_year" >
                                @forelse($bsc_year_passing as $key=>$val)
                                 <option value="{{ $val->id ?? '' }}"
               ...
               <div class="row">
                  <div class="col-sm-6 col-md-6 col-xs-6">
                      <div class="form-group">
                          ...
                          <select name="session_phd" class="form-control _session_select" id="session_phd" >
                            <option value="">--Select--</option>
                            @forelse($examsessions as $key=>$val)
                  ...
                  <div class="col-sm-6 col-md-6 col-xs-6">
                      <div class="form-group">
                          ...
                          <select class="form-control bsc_year_passing _year_select" name="phd_certificate_year" id="phd_certificate_year" >
                                @forelse($bsc_year_passing as $key=>$val)
