                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td style="display: flex;">
                                ...
                                @can('year-batch-edit')
                                    <a class="btn btn-sm btn-primary  mr-2" href="{{ route('year-batch.edit',$value->id) }}">
                                      <i class="nav-icon fas fa-edit"></i>
                                    </a>
                                @endcan
                                @can('year-batch-delete')
                                    {!! Form::open(['method' => 'DELETE','route' => ['year-batch.destroy', $value->id],'style'=>'display:inline']) !!}
