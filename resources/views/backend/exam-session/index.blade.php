                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td style="display: flex;">
                                ...
                                @can('exam-session-edit')
                                    <a class="btn btn-sm btn-primary  mr-2" href="{{ route('exam-session.edit',$value->id) }}">
                                      <i class="nav-icon fas fa-edit"></i>
                                    </a>
                                @endcan
                                @can('exam-session-delete')
                                    {!! Form::open(['method' => 'DELETE','route' => ['exam-session.destroy', $value->id],'style'=>'display:inline']) !!}
