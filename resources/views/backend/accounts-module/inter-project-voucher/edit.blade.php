        ...
        <div class="row mb-2">
          <div class=" col-sm-12 ">
            <h1 class="m-0 _page_name">
              ...
              <a class="btn btn-sm btn-info" title="List" href="{{ route('inter-project-voucher.index') }}"> <i class="nav-icon fas fa-list"></i> 
              </a>
            ...
            <a title="Add New" class="btn  btn-sm btn-info" href="{{ route('inter-project-voucher.create') }}"> <i class="nav-icon fas fa-plus"></i> {{ __('label.Add New') }} </a>
                @endcan 
                     ...
                     <a class="btn btn-sm btn-default mr-3" href="{{ route('inter-project-voucher.show',$data->id) }}">
