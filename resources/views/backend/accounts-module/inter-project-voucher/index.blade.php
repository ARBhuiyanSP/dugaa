...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 _page_name"><a  href="{{ route('inter-project-voucher.index') }}"> {!! $page_name ?? '' !!} </a>  
                             ...
                             <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item " href="{{ route('inter-project-voucher.show',$data->id) }}">
                                        View
                                      </a>
                                     @can('inter-project-voucher-edit')
                                        <a class="dropdown-item " href="{{ route('inter-project-voucher.edit',$data->id) }}">
                                         Edit
                                        </a>
                                    @endcan
                                    @php
                                    ...
                                    @endcan
                                     ...
                                     @can('inter-project-voucher-delete')
                                    {!! Form::open(['method' => 'DELETE','route' => ['inter-project-voucher.destroy', $data->id],'style'=>'display:inline']) !!}
