                    ...
                    <div class="col-sm-10">
                      <div class="row">
                        ...
                        <div class="col-sm-5">From: 
                                      ...
                                      <input type="date" name="_datex" class="form-control datetimepicker-input_datex" data-target="#reservationdate_datex" value="@if(isset($request->_datex)) {{$request->_datex ?? ''}}  @endif" />
                                      
                                  </div>
                       
                        <div class="col-sm-5">To: 
                          
                                      <input type="date" name="_datey" class="form-control datetimepicker-input_datey" data-target="#reservationdate_datey" value="@if(isset($request->_datey)) {{$request->_datey ?? ''}}  @endif" />
                    ...
                    @csrf
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                              <div class="form-group ">
                                 @can('voucher-print')
                        <a class=" dropdown remove_from_header">
