        ...
        <div class="row mb-2">
          <div class=" col-sm-12 ">
            <h1 class="m-0 _page_name">
              ...
              <a class="btn btn-sm btn-info" title="List" href="{{ route('easy-voucher.index') }}"> <i class="nav-icon fas fa-list"></i> </a>
              </h1>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                {!! Form::open(array('route' => 'easy-voucher.store','method'=>'POST','class'=>'voucher-form')) !!}
                    <div class="row">
