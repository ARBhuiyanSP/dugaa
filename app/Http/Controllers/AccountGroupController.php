   ...
   public function index(Request $request)
    {
        ...
        if($request->has('print')){
            if($request->print =="single"){
                return view('backend.accounts-module.account-group.master_print',compact('datas','page_name','request','limit'));
            }
         }

         $account_types = AccountHead::select('id','_name')->orderBy('_name','asc')->get();

        return view('backend.accounts-module.account-group.index',compact('datas','page_name','account_types','request','limit'));
    }
    ...
    public function create()
    {
         $page_name = $this->page_name;
         $account_types = AccountHead::select('id','_name')->orderBy('_name','asc')->get();
       return view('backend.accounts-module.account-group.create',compact('account_types','page_name'));
    }
    ...
    public function show(AccountGroup $accountGroup)
    {
        $page_name = $this->page_name;
        $data = $accountGroup;
        return view('backend.accounts-module.account-group.show',compact('data','page_name'));
    }
     ...
     public function edit(AccountHead $accountHead,$id)
    {
        ...
        $data = AccountGroup::with('account_type')->find($id);
         $account_types = AccountHead::select('id','_name')->orderBy('_name','asc')->get();
        return view('backend.accounts-module.account-group.edit',compact('data','page_name','account_types'));
    }
