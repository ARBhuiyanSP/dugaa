...
class VoucherMasterController extends Controller
{
        ...
        if($request->_voucher_type =="CR"){
         ...
         if($request->has('print')){
            if($request->print =="single"){
                return view('backend.accounts-module.voucher.master_print',compact('datas','page_name','account_types','request','account_groups','current_date','current_time'));
            }

            if($request->print =="detail"){
                return view('backend.accounts-module.voucher.details_print',compact('datas','page_name','account_types','request','account_groups','current_date','current_time','limit'));
            }
         }

        return view('backend.accounts-module.voucher.index',compact('datas','page_name','account_types','request','account_groups','current_date','limit'));
    }
    ...
    public function create()
    {
       ...
       return view('backend.accounts-module.voucher.create',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types'));
    }
...
WHERE t1._account_group_id=(SELECT _cash_group FROM general_settings ) " );
       ...
       return view('backend.accounts-module.voucher.cash-receive',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types','_defalut_group_ledgers'));
    }
...
WHERE t1._account_group_id=(SELECT _bank_group FROM general_settings ) " );
       ...
       return view('backend.accounts-module.voucher.bank-receive',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types','_defalut_group_ledgers'));
    }
...
WHERE t1._account_group_id=(SELECT _cash_group FROM general_settings ) " );
       ...
       return view('backend.accounts-module.voucher.cash-payment',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types','_defalut_group_ledgers'));
    }
...
WHERE t1._account_group_id=(SELECT _bank_group FROM general_settings ) " );
       ...
       return view('backend.accounts-module.voucher.bank-payment',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types','_defalut_group_ledgers'));
    }
...
//return $request->all();
    ...
    public function show($id)
    {
       ...
       return view('backend.accounts-module.voucher.show',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types','data'));
    }
    ...
    public function edit($id)
    {
       ...
       return view('backend.accounts-module.voucher.edit',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types','data'));
    }
    ...
    public function voucherPrint($id){
       ...
       return view('backend.accounts-module.voucher.print',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types','data'));
    }
    public function moneyReceiptPrint($id){
       ...
       return view('backend.accounts-module.voucher.monty_receipt',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types','data'));
    }
    public function moneyPaymentReceiptPrint($id){
       ...
       return view('backend.accounts-module.voucher.payment_receipt',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','voucher_types','data'));
    }
