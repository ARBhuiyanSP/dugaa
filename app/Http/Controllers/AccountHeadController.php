...
class AccountHeadController extends Controller
{
       ...
       if($request->has('limit')){
        ...
        if($request->has('print')){
            if($request->print =="single"){
                return view('backend.accounts-module.account-type.master_print',compact('datas','page_name','request','limit'));
            }
         }

         $base_accounts =MainAccount::get();
         

        return view('backend.accounts-module.account-type.index',compact('datas','request','page_name','limit','base_accounts'));
    ...
    {
        $page_name = $this->page_name;
        return view('backend.accounts-module.account-type.create',compact('page_name'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.accounts-module.account-type.show',compact('data','page_name'));
    }
    ...
    public function edit(AccountHead $accountHead,$id)
    {
        ...
        return view('backend.accounts-module.account-type.edit',compact('data','page_name'));
    }
